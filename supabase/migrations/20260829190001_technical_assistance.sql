-- Solicitudes de asesoría técnica en obra, con RLS heredada del proyecto.
...
create table public.technical_assistance (
  ...
  contact_phone text,
  preferred_date text,
  -- El servicio va incluido: costo 0 por defecto.
...
-- Hereda la visibilidad del proyecto, como el resto de tablas hijas.
...
-- Solo para proyectos accesibles y a nombre propio.
...
-- Programar y asignar especialista es del personal; el cliente solo solicita.
...
-- Crea la solicitud y avanza el paso 6 de la cronología en la misma transacción.
...
begin
  ...
  -- Una solicitud abierta por proyecto: un doble clic no genera dos visitas.
  ...
  -- Paso 6: acompañamiento técnico en obra.
