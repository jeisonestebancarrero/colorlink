-- El descuento del kit sale de solutions.discount_percent, el mismo que anuncia la tienda.
-- Antes era un 8 % fijo sobre todo el carrito, incluidos los productos que no eran del kit.
