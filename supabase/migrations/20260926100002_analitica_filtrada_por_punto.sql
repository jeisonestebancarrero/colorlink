-- Al filtrar la analítica por un punto, los pedidos con envío (sin punto) ya no se suman a ese punto.
...
begin
  ...
  base as (
    ...
    where o.status <> 'CANCELADO'
      ...
      -- Sin punto (envíos) solo cuenta cuando no se filtra por punto: filtrar es pedir las ventas de ese punto.
      and (o.pickup_location_id = any(v_sedes) or (o.pickup_location_id is null and _puntos is null))
